// Pin connection wiring for Arduino Pro Mini: BUSY -> 7, RST -> 9, DC -> 8, CS-> 10, SCL -> 13, SDA -> 11
...
GxEPD2_BW<GxEPD2_154_D67, MAX_HEIGHT(GxEPD2_154_D67)> display(GxEPD2_154_D67(/*CS=5*/ 10, /*DC=*/ 8, /*RES=*/ 9, /*BUSY=*/ 7)); // GDEH0154D67 200x200, SSD1681
